        ...
        <div className="flex items-center gap-4 relative w-full min-w-[1174px] h-screen">
          ...
          <div className="max-h-[90vh] overflow-y-auto p-4 w-full bg-[#0d1217] rounded-[16px_0px_0px_16px] text-white p-8">
            ...
            <div className="max-w-6xl mx-auto space-y-6">
              ...
              >
                {/* DETAILS BOX */}
                <h1 className="text-3xl font-bold">BD-123</h1>
                ...
                <div className="mt-5 rounded-md bg-[#252A2E] p-5 space-y-10">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        value="Figma ipsum component variant"
                        readOnly
                      />
                    </div>
                    <div>
                      <label className="block text-sm  text-slate-300">Design Type</label>
                      <input
                        className="mt-3 bg-[#3C4348] rounded-md w-full p-2 text-white text-[14px]"
                        value="CAD 123"
                        readOnly
                  ...
                  <div className="grid grid-cols-3 gap-4 text-sm">
                    <div>
                      <div className="text-slate-300 font-semibold mb-1">Uploaded By</div>
                    ...
                    <div>
                      <div className="text-slate-300 font-semibold mb-1">Uploaded On</div>
                      <div className="mt-3  text-white">5/12/2025 18:25 PM</div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div>
                      ...
                      <textarea
                        className="mt-3 bg-[#3C4348] w-full h-[88px] p-3 rounded-md text-white text-sm"
                        rows={2}
                        readOnly
                      >
                        Figma ipsum component variant main layer. Figma layer layer content share layout prototype resizing pen. Arrange bullet layout vector plugin text inspect. Figma vector opacity fill shadow arrow strikethrough. Rectangle project ellipse layout export object frame select arrow. Select background.
              ...
              <div style={{
                ...
                <button className="px-4 py-2 rounded-md bg-slate-800 text-white">View Project</button>
              </div>
              {/* ACTION BUTTONS */}
...
export default BaseDrawerModel;